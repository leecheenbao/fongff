...
import fongff.security.JwtAuthFilter;
import fongff.security.UnauthEntryPoint;
import fongff.security.UserDetailsServiceImpl;
...
//        http.addFilterBefore(myCorsFilter, UsernamePasswordAuthenticationFilter.class);
